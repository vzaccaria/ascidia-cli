...
This has been written by Mark Frimston. I am just putting this on npm 
so that every one can enjoy it as a command line tool.

Beware, you need Python2 and PyCairo. If you have a Mac, just use brew.
...
* [Asciidia](https://github.com/aurora/asciidia) - A similar project with a very similar
  name (it has an extra 'i'), in PHP. Creates ditaa-like diagrams, directory trees, 
  syntax-diagrams and identicons.
